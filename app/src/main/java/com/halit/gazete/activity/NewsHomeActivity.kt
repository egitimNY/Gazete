package com.halit.gazete.activity
...
import com.halit.gazete.fragment.NewsFavouriteFragment
import com.halit.gazete.fragment.NewsHomeFragment
...
class NewsHomeActivity : BaseActivity() {
    ...
    init {
        ...
        queryMap.put("Turkey","tr")
        queryMap.put("US","us")
        queryMap.put("Canada","ca")
    }
